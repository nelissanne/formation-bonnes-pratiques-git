...
3. Créer un dossier `data` à la racine du projet et à l'intérieur de celui-ci un fichier `data/raw.csv` 
4. Ajouter au `.gitignore`: `data/raw.csv`
5. Effectuer un *commit* pour ajouter le fichier `.gitignore` au projet Git
6. Vérifier que toutes les règles ajoutées précédemment fonctionnent comme attendu
:::
