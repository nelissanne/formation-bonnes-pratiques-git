...
4. Ouvrir une `Merge Request` (`MR`) pour proposer d'intégrer vos changements sur la branche principale du dépôt [`git-exo`](https://github.com/avouacr/git-exo.git)
