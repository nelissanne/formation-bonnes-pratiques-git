...
3. Effectuer un `commit` avec les modifications de votre choix, puis pousser les changements sur une nouvelle branche du dépôt distant (`git push -u origin <votre_branche>`)
